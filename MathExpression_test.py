...
class TestMathExpression(unittest.TestCase):
    def test_MathExpression(self):
        ...
        # test3
        str = "a + 2 - f(b, c)*(b - c)"
        test3 = expression(str=str, func_dic=lambda a, b: sin(a) + b,
                           a=2, b=1, c=3)
        ...
        test4 = expression(str=str, func_dic=lambda a, b, c, d: sin(a)+b*c-d,
                           a=2, b=1, c=3, d=4, e=8)
        ...
        # test5
        str = "a + 2 - f(b,c,d,e)*(b - c)"
        test5 = expression(str=str, func_dic=lambda a, b, c, d: sin(a)*b*(c-d),
                           a=2, b=1, c=3, d=4, e=8)
